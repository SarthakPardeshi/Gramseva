...
import { ShieldCheck, Lock, Phone, ArrowRight, Eye, EyeOff } from 'lucide-react'; // Swapped Landmark for ShieldCheck
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-12 pr-12 py-4 bg-slate-50 border border-slate-200 rounded-2xl outline-none focus:ring-2 focus:ring-blue-800 transition-all font-semibold text-slate-700"
                  placeholder="••••••••"
